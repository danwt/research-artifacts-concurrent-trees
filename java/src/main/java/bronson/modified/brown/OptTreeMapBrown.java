...
public class OptTreeMapBrown<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    private static final long OVLGrowCountMask =
            ((1L << OVLBitsBeforeOverflow) - 1) << OVLGrowCountShift;
    ...
    public OptTreeMapBrown() {
    }

    public OptTreeMapBrown(final Comparator<? super K> comparator) {
        ...
        while (true) {
            ...
            if (right == null) {
                ...
                if (isShrinkingOrUnlinked(ovl)) {
                    ...
                    final Object vo = attemptUpdate(key, k, func, expected, newValue, rootHolder,
                            right, ovl);
                    if (vo != SpecialRetry) {
                        return vo;
                    }
        ...
        while (true) {
            ...
            if (right == null) {
                ...
                if (isShrinkingOrUnlinked(ovl)) {
                    ...
                    // this is the protected .right
                    final Map.Entry<K, V> result = attemptRemoveExtreme(dir, rootHolder, right,
                            ovl);
                    if (result != null) {
                        return result;
                    }
    ...
    private Object succNode(final Comparable<? super K> keyCmp, final Node<K, V> node,
                            final long nodeOVL) {
        while (true) {
    ...
    private class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        @Override
        public int size() {
            return OptTreeMapBrown.this.size();
        }

        @Override
        public boolean isEmpty() {
            return OptTreeMapBrown.this.isEmpty();
        }

        @Override
        public void clear() {
            OptTreeMapBrown.this.clear();
        }
        ...
        public boolean contains(final Object o) {
            ...
            final Object actualVo = OptTreeMapBrown.this.getImpl(k);
            if (actualVo == null) {
                // no associated value
                return false;
            }
        ...
        public boolean remove(final Object o) {
            ...
            final Object k = ((Entry<?, ?>) o).getKey();
            final Object v = ((Entry<?, ?>) o).getValue();
            return OptTreeMapBrown.this.remove(k, v);
        }
    ...
    private class EntryIter implements Iterator<Entry<K, V>> {
        ...
        @Override
        public void remove() {
            OptTreeMapBrown.this.remove(mostRecentNode.key);
        }
    }
