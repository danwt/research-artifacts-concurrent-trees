...
public class CrainContentionFriendly<K, V> extends AbstractMap<K, V> implements
    ...
    private class MaintenanceThread extends Thread {
        CrainContentionFriendly<K, V> map;

        MaintenanceThread(CrainContentionFriendly<K, V> map) {
            this.map = map;
        }
    ...
    // Constructors
    public CrainContentionFriendly() {
        // temporary
        this.startMaintenance();
    }

    public CrainContentionFriendly(final Comparator<? super K> comparator) {
        // temporary
        this.startMaintenance();
