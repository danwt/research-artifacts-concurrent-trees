...
public class Main {
    ...
    public final class LeftRightChainGenerator extends Generator<Integer> {
        ...
        int rand = -1, last = -1, dir = RIGHT, cnt = 0, ret = 0;
        ...
        public Integer next() {
            if (cnt == 0) {
                ...
                chainSize = rng.nextNatural() % originalChainSize + 1;
                dir = rand <= Integer.MAX_VALUE / 2 ? LEFT : RIGHT;
            }
            ret = (rand + dir*cnt + maxKey) % maxKey;
