...
TEST_CASE("seq::repeat") {
  prop("repeatedly returns the given value", [](const std::string &value) {
  ...
  prop("copies are equal", [](const std::string &value) {
...
struct FromContainerTests {
  ...
  static void exec() {
    ...
    templatedProp<T>("copies are equal", [](const T &elements) {
...
TEST_CASE("seq::iterate") {
  ...
  prop("copies are equal", [](int start, int inc) {
    const auto func = [=](int x) { return x + inc; };
