...
template <typename T, typename>
Variant<Type, Types...> &
Variant<Type, Types...>::operator=(const T &value) noexcept {
...
template <typename T, typename>
Variant<Type, Types...> &
Variant<Type, Types...>::operator=(T &&value) noexcept {
  static_assert(isValidType<T>(), "T is not a valid type of this variant");
...
template <typename Type, typename... Types>
Variant<Type, Types...> &
Variant<Type, Types...>::operator=(const Variant &rhs) noexcept(
    AllIs<std::is_nothrow_copy_constructible, Type, Types...>::value
...
template <typename Type, typename... Types>
Variant<Type, Types...> &
Variant<Type, Types...>::operator=(Variant &&rhs) noexcept(
